...
function SideNav({ children }) {
  ...
  const getTabClass = (path) => {
    return `flex items-center py-1 rounded transition-all duration-300 relative group ${activeTab === path ? "bg-[#13BA8885] text-black" : "hover:bg-gray-100 text-gray-700"
